...
class ScriptSettingsApp(QWidget):
    ...
    def run_anti_lunge_script(self, value):
        ...
        # Use base_dir to dynamically determine where to run the script from
        base_dir = os.path.dirname(os.path.abspath(__file__))
        script_path = os.path.join(base_dir, "AECreative_UI-main", "Creative SCRIPTS", "Anti Knife Lunge.py")
